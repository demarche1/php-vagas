    ...
    <div class="row p-5 text-dark">
        <div class="col">
            <form method="POST">
                ...
                <?php echo isset($_GET['loginError']) ? '<div class="mt-3 alert alert-warning"> Usuário ou senha incorretos </div>' : ''; ?>
                <?php echo isset($_GET['loginSuccess']) ? '<div class="mt-3 alert alert-success"> Usuário logado com sucesso </div>' : ''; ?>
        ...
        <div class="col">
            <form method="POST">
                ...
                <?php echo isset($_GET['registerError']) ? '<div class="mt-3 alert alert-warning"> Erro ao registrar usuário </div>' : ''; ?>
                <?php echo isset($_GET['registerSuccess']) ? '<div class="mt-3 alert alert-success"> Usuário registrado com sucesso </div>' : ''; ?>
                <div class="form-group">
